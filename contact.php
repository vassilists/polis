...
$your_email = "soron80@gmail.com"; // πρέπει να αντικατασταθεί με του πόλη
$subject = "Contact Message"; // subject of the email that is sent
$thanks_page = "thankyou.php"; // path to the thank you page following successful form submission
...
$mail_sent = @mail ($your_email, $subject, $email_body, "From: $nam <$ema>" . "\r\n" . "Reply-To: $nam <$ema>");
echo $mail_sent ? "Mail sent" : "Mail failed";
header ("Location: $thanks_page");
//echo "Thank you for your message. <a href=menu.php>Click Here to Return to main menu</a>";
exit();
}  
